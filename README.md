...
# Objectives
The goal of this project is to identify, analyse and evaluate potential risks to the Call Centre's operations, assets (People, Hardware, Software) and compliance objectives, and to provide actionable treatment recommendations that help the client prioritise and implement strong security protocols for their organisation’s call centre operations.
